        ...
        <header className={css.header}>
            <div className={css.logo_menu}>
                <div className={css.logo}>
                    ...
                    <NavLink to='/catalog' className={css.NavLink}><div classname= {css.button}>Каталог</div></NavLink>
                </div>
                <nav className={css.navigation}>
                    ...
                    {
                        isAuth === false ?
                        <NavLink to='/entrance' className={css.NavLink}>Вход</NavLink>
                        :
                        <NavLink to='/entrance' className={css.NavLink}>Выход</NavLink>
                    }
                </nav>
            </div>            
